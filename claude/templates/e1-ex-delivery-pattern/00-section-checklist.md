...
| 6 | Business Invariants | Uniqueness, integrity, state-transition rules enforced via specifications | [src/domain/economic-system/capital/account/specification/](../../../src/domain/economic-system/capital/account/specification/) |
...
| 9 | Application & Engine Services | Handlers, validators, coordinators per command — T1M (workflow steps) + T2E (single-shot handlers) | [src/engines/T1M/domains/economic/](../../../src/engines/T1M/domains/economic/) and [src/engines/T2E/economic/](../../../src/engines/T2E/economic/) |
...
| 15 | Cross-System Integration | Linkage to structural / identity / policy / chain / economic via shared events | [src/shared/contracts/](../../../src/shared/contracts/) |
