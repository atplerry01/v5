...
**Runs after:** any prompt classified `validation` / `phase1.5-gate`, and against any modified file under `/scripts/validation/`, `/docs/validation/`, `/claude/guards/e2e-validation.guard.md`.
...
`/docs/validation/e2e-validation-report.md` MUST cite `e2e-validation.guard.md` in its preamble. Missing = S2.
