...
/// <summary>
/// Helpers for posting and reading the canonical ApiRequest/ApiResponse
/// envelopes. Mirrors the capital/exchange envelope helpers.
/// </summary>
public static class ComplianceApiEnvelope
{
