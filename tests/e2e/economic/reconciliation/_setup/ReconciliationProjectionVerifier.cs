...
/// <summary>
/// Direct projection-schema verifier for the reconciliation suite.
/// ProcessController exposes no GET endpoint, so the E2E tests validate
/// state entirely through the projection row written by the reducer.
/// </summary>
public static class ReconciliationProjectionVerifier
{
    ...
    {
        await using var conn = new NpgsqlConnection(ReconciliationE2EConfig.ProjectionsConnectionString);
