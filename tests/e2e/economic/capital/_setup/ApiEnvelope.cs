...
/// <summary>
/// Helpers for posting and reading the canonical ApiRequest/ApiResponse envelopes.
/// Centralised so per-domain tests stay terse and serialization rules stay uniform.
/// </summary>
