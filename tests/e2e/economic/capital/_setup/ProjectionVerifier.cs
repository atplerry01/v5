...
/// <summary>
/// Direct projection-schema verification for capital E2E tests. Polls the
...
public static class ProjectionVerifier
{
    ...
    {
        await using var conn = new NpgsqlConnection(CapitalE2EConfig.ProjectionsConnectionString);
