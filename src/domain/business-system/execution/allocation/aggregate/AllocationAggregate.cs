...
public sealed class AllocationAggregate
{
    ...
    public ExecutionResourceId ResourceId { get; private set; }
    ...
    public static AllocationAggregate Create(AllocationId id, ExecutionResourceId resourceId, int requestedCapacity)
    {
