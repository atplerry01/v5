...
## Responsibility
Geographic/market coverage scope of a provider.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, provider, provider-coverage)`; the domain-group is a folder-level grouping and is not part of the route.
