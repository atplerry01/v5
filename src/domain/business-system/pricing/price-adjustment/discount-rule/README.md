...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, pricing, discount-rule)`; the domain-group is a folder-level grouping and is not part of the route.
