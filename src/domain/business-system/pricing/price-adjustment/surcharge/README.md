...
## Responsibility
Additive adjustment applied on top of a base price.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, pricing, surcharge)`; the domain-group is a folder-level grouping and is not part of the route.
