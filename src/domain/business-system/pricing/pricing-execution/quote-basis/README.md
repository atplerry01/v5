...
## Responsibility
The basis (inputs/context) used to compute a quote.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, pricing, quote-basis)`; the domain-group is a folder-level grouping and is not part of the route.
