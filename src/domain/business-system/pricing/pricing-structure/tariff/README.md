...
## Responsibility
Tariff structure applied to a category of offerings.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, pricing, tariff)`; the domain-group is a folder-level grouping and is not part of the route.
