...
**Domain:** fulfillment-instruction
**Namespace:** `Whycespace.Domain.BusinessSystem.Order.OrderChange.FulfillmentInstruction`

## Responsibility
Instruction directing how a specific order fulfilment must proceed.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, order, fulfillment-instruction)`; the domain-group is a folder-level grouping and is not part of the route.
