...
## Responsibility
Binding of a policy to service applicability as a business-meaning concept.
...
## Routing
Per DS-R8, `DomainRoute` remains the 3-tuple `(business-system, service, policy-binding)`; the domain-group is a folder-level grouping and is not part of the route.
