...
public sealed class AddMediaMetadataEntryHandler : IEngine
{
    public async Task ExecuteAsync(IEngineContext context)
    {
        if (context.Command is not AddMediaMetadataEntryCommand cmd) return;
        ...
        aggregate.AddEntry(
            ...
            new MediaMetadataValue(cmd.Value),
