...
namespace Whycespace.Platform.Api.Controllers.Economic.Transaction.Transaction;

/// <summary>
/// Transaction envelope API. The <c>record-expense</c> endpoint is an
/// orchestration entry point that dispatches into the sibling
/// <c>economic/transaction/expense</c> domain as part of the transaction
/// saga (Initiate → RecordExpense → Commit/Fail). This cross-domain
/// dispatch is intentional and owned by the transaction domain.
/// </summary>
[Authorize]
[ApiController]
