...
namespace Whycespace.Platform.Api.Controllers.Economic.Transaction.Settlement;
...
public sealed class SettlementController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return result.IsSuccess
            ? Ok(ApiResponse.Ok(new CommandAck("settlement_initiated"), result.CorrelationId, _clock.UtcNow))
        ...
        CancellationToken cancellationToken)
    {
        ...
        return result.IsSuccess
            ? Ok(ApiResponse.Ok(new CommandAck("settlement_completed"), result.CorrelationId, _clock.UtcNow))
            : BadRequest(ApiResponse.Fail(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return result.IsSuccess
            ? Ok(ApiResponse.Ok(new CommandAck("settlement_failed"), result.CorrelationId, _clock.UtcNow))
            : BadRequest(ApiResponse.Fail(
