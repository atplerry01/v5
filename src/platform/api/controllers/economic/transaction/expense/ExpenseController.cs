...
namespace Whycespace.Platform.Api.Controllers.Economic.Transaction.Expense;
...
public sealed class ExpenseController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return result.IsSuccess
            ? Ok(ApiResponse.Ok(new CommandAck("expense_recorded"), result.CorrelationId, _clock.UtcNow))
