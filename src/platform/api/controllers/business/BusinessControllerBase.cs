...
namespace Whycespace.Platform.Api.Controllers.Business;

// Shared helper base for business classification controllers. Mirrors the
// economic CapitalControllerBase: dispatch command with consistent ack/fail
// envelope, load a read-model row from the projections ring by aggregate_id.
