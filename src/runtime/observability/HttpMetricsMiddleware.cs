...
/// Tracks request duration, count, and errors at the HTTP boundary.
/// This is separate from the runtime pipeline MetricsMiddleware which tracks
/// command execution within the control plane.
/// </summary>
